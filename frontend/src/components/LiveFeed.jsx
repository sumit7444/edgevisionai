...
import { Maximize2, Minimize2, Camera, VideoOff } from 'lucide-react'
...
export default function LiveFeed({ videoRef, canvasRef, detections, zones, workers = [], cameraError = null }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 font-mono text-[10px] text-amber bg-black/60 px-2 py-1 tracking-widest z-10">
        ● REC
      </div>
